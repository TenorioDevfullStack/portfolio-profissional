...
interface ShineShadowGradientBorder3DCardProps {
...
export function ShineShadowGradientBorder3DCard({
  children,
  className,
  ...
  borderColor = "#ff0080",
  intensity = 10,
}: ShineShadowGradientBorder3DCardProps) {
  ...
  return (
    <motion.div
      ...
      className={cn(
        "group relative h-full w-full overflow-hidden rounded-xl bg-white/5 backdrop-blur-lg",
        className
      )}
    >
      <motion.div
      ...
      <div
        ...
        className="relative z-10 m-[1px] h-full w-full rounded-xl bg-background p-6"
      >
        {children}
      </div>
    </motion.div>
