...
interface ShineShadowGradientBorder3DGlassParallaxRippleTiltZoomCardProps {
...
export function ShineShadowGradientBorder3DGlassParallaxRippleTiltZoomCard({
  children,
  className,
  ...
  tiltIntensity = 15,
  zoomIntensity = 1.1,
}: ShineShadowGradientBorder3DGlassParallaxRippleTiltZoomCardProps) {
  ...
  const zoomStyle = {
    transform: isHovered ? `scale(${zoomIntensity})` : "scale(1)",
  };
