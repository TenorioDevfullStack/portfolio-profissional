...
interface ShineShadowGradientBorder3DGlassParallaxRippleTiltCardProps {
...
export function ShineShadowGradientBorder3DGlassParallaxRippleTiltCard({
  children,
  className,
  ...
  tiltIntensity = 15,
}: ShineShadowGradientBorder3DGlassParallaxRippleTiltCardProps) {
