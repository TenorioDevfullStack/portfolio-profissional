...
interface ShineShadowGradientBorder3DGlassParallaxCardProps {
...
export function ShineShadowGradientBorder3DGlassParallaxCard({
  children,
  className,
...
}: ShineShadowGradientBorder3DGlassParallaxCardProps) {
